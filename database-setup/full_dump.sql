...
--
-- Table structure for table `container_loading_items`
--
...
--
-- Table structure for table `delivery_containers`
--
...
--
-- Table structure for table `harvesting_seasons`
--
...
--
-- Table structure for table `paddy_grades`
--
...
--
-- Table structure for table `paddy_products`
--
...
--
-- Table structure for table `receipt_print_log`
--
...
--
-- Table structure for table `receipt_split_history`
--
...
--
-- Table structure for table `receipt_split_portions`
--
...
--
-- Table structure for table `sales_purchase_mapping`
--
...
--
-- Table structure for table `season_closure_summary`
--
...
--
-- Table structure for table `season_grade_pricing`
--
...
--
-- Table structure for table `season_grade_standards`
--
...
--
-- Table structure for table `season_price_history`
--
...
--
-- Table structure for table `season_product_prices`
--
...
--
-- Table structure for table `season_type_config`
--
...
--
-- Table structure for table `system_print_settings`
--
...
--
-- Table structure for table `user_print_preferences`
--
...
--
-- Temporary view structure for view `vw_container_loading_details`
--
...
--
-- Temporary view structure for view `vw_current_inventory_summary`
--
...
--
-- Temporary view structure for view `vw_daily_purchase_summary`
--
...
--
-- Temporary view structure for view `vw_farmer_purchase_summary`
--
...
--
-- Temporary view structure for view `vw_grade_performance`
--
...
--
-- Temporary view structure for view `vw_manufacturer_sales_summary`
--
...
--
-- Temporary view structure for view `vw_pending_payments`
--
...
--
-- Temporary view structure for view `vw_production_purchases`
--
...
--
-- Temporary view structure for view `vw_season_performance`
--
...
--
-- Table structure for table `weighing_logs`
--
...
--
-- Dumping routines for database 'paddy_collection_db'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_calculate_purchase_amount` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_close_season` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_receipt_number` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_sales_number` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_farmer_stats` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_stock_level` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
--
-- Final view structure for view `vw_container_loading_details`
--
...
--
-- Final view structure for view `vw_current_inventory_summary`
--
...
--
-- Final view structure for view `vw_daily_purchase_summary`
--
...
--
-- Final view structure for view `vw_farmer_purchase_summary`
--
...
--
-- Final view structure for view `vw_grade_performance`
--
...
--
-- Final view structure for view `vw_manufacturer_sales_summary`
--
...
--
-- Final view structure for view `vw_pending_payments`
--
...
--
-- Final view structure for view `vw_production_purchases`
--
...
--
-- Final view structure for view `vw_season_performance`
--
...
-- Dump completed on 2026-01-08 22:30:54
